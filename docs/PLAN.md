...
| ◐ | Hoàn thiện tracking, seed, checkpoint resume, lưu dự đoán và quét threshold | Trước train mới | **19/09: Pha 1 + 3 + 4 xong** — manifest/vân tay/seed đầy đủ, prediction + quét ngưỡng + phân tích lỗi cho cả ba run. Còn thiếu: checkpoint resume (optimizer/scheduler/RNG) và Pha 5. |
